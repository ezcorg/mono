---
title: "Trying to build a company that doesn't make the world worse"
...
In a meta where executives and majority shareholders rule with no accountability, it's difficult for employees to do much to influence an organization's direction beyond resigning. No voting power, no leverage, bills to pay, and a job market that is widely regarded as *not great* means that salvation probably won't come from the bottom.
