...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_simple_handler_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_simple_handler_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:component:simple-handler:simple-handler:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6649] = *b"\
...
wasi:http/incoming-handler@0.2.6\x05\x11\x04\0'component:simple-handler/simple-h\
andler\x04\0\x0b\x14\x01\0\x0esimple-handler\x03\0\0\0G\x09producers\x01\x0cproc\
